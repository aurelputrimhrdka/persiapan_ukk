...
@section('content')
    <div class="container">
        ...
        @endif
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('vbarangmasuk.create') }}" class="btn btn-md btn-success mb-3">TAMBAH BARANG MASUK</a>
                    </div>
                </div>
                    ...
                    <tbody>
                        @forelse ($rsetBarangMasuk as $rowbarangmasuk)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('vbarangmasuk.destroy', $rowbarangmasuk->id) }}" method="POST">
                                    <a href="{{ route('vbarangmasuk.show', $rowbarangmasuk->id) }}" class="btn btn-sm btn-dark"><i class="fa fa-eye"></i></a>
                                    <a href="{{ route('vbarangmasuk.edit', $rowbarangmasuk->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-pencil-alt"></i></a>
                                        @csrf
                                        @method('DELETE')
